"use strict";
/* build-hook-start *//*00001*/try { require('/users/joseane/.vscode/extensions/wallabyjs.console-ninja-0.0.202/out/buildhook/index.js').default({tool: 'cypress'}); } catch(cjsError) { try { import('file:///users/joseane/.vscode/extensions/wallabyjs.console-ninja-0.0.202/out/buildhook/index.js').then(m => m.default.default({tool: 'cypress'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
